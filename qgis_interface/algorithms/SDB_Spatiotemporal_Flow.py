...
class SDBSpatiotemporalFlow(SDBMasterOrchestrator):
    ...
    def displayName(self):
        return self.tr("1.3 SDB Spatiotemporal Masterflow (Multi-Year)")

    def group(self):
        return self.tr("1. End-to-End Masterflows")
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterField(
                ...
                "📅 [2.1] Year / Date Field (Optional for Global ICESat)",
                defaultValue="year",
        ...
        self.addParameter(
            QgsProcessingParameterBoolean(
                ...
                "🤖 [3.5] Enable Depth Variance Correction (Spatiotemporal Flow)",
                defaultValue=True,
            )
        )
